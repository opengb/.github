...
# Organization Guidelines & Conventions
...
1. Review the relevant sections for your project type
2. Apply standards to your repository
3. Link to this repository in your project's README
...
2. Submit a pull request with the proposed updates
3. Get approval from organization maintainers
4. Update all affected repositories
